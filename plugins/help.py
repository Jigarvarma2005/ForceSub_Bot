        ...
        try:
            ...
            if user.status == "kicked":
               await client.send_message(
                   ...
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/YungMoney9).",
                   parse_mode="markdown",
	        ...
	        reply_markup=InlineKeyboardMarkup(
                    [
                        [
                           InlineKeyboardButton("Join Updates Channel", url="https://t.me/YourManChannel"),
                           InlineKeyboardButton("Support Group", url="https://t.me/yourmandiscussion")
                      ],
                     [
                           InlineKeyboardButton("🧑‍💻Devloper🧑‍💻", url="https://t.me/YungMoney9")
                     ]
                 ]
             ),
        parse_mode="markdown",
...
async def _source_code(client, message):
	...
	reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Contact", url="https://t.me/YungMoney9")
                ],
                [
                    InlineKeyboardButton("Join Updates Channel", url="https://t.me/YourManChannel"),
                    InlineKeyboardButton("Support Group", url="https://t.me/yourmandiscussion")
    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               await client.send_message(
                   chat_id=message.chat.id,
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/yourmandiscussion).",
                   parse_mode="markdown",
                   disable_web_page_preview=True
               )
               return
            ...
            await client.send_message(
                chat_id=message.chat.id,
                text="Hey use this command in my pm. \nFor more help ask in my [Support Group](https://t.me/yourmandiscussion).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
